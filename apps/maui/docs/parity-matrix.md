...
| `packages/application/test/unit/get-group-overview.usecase.test.ts` | Query returns composed group overview model and errors for missing group. | `apps/maui/tests/LuSplit.Application.Tests/GetGroupOverviewUseCaseTests.cs` |
